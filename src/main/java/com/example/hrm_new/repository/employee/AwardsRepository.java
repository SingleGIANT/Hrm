...
public interface AwardsRepository extends JpaRepository<Awards, Long> {
	...
	@Query(value = " select a.awards_id, a.description, a.gift, a.date, a.cash, e.employee_id, e.first_name, e.last_name, ap.awards_photo_id,ap.url, a.status ,a.awards_type"
	...
	@Query(value = "SELECT a.awards_id, a.description, a.gift, a.date, a.cash, e.employee_id, e.first_name, e.last_name, ap.awards_photo_id, ap.awards_photo, a.status,a.awards_type "
			+ " FROM awards AS a " + "JOIN awardsphoto AS ap ON a.awards_id = ap.fkawards_id "
			+ " JOIN employee AS e ON e.employee_id = a.employee_id "
	...
	@Query(value = " SELECT a.awards_id, a.description, a.gift, a.date, a.cash, e.employee_id, e.first_name, e.last_name, ap.awards_photo_id, ap.awards_photo,a.awards_type,a.status, count_sub.awardsCount " +
	        " FROM awards AS a " +
	        " JOIN awardsphoto AS ap ON a.awards_id = ap.fkawards_id " +
	        " JOIN employee AS e ON e.employee_id = a.employee_id " +
	        " JOIN (" +
